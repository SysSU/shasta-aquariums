        ...
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="grid gap-20">
                ...
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Monthly or Weekly schedules</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>
                        Refill fresh water revisor with fresh filtered (RODI)
                        water
                      </span>
                    </li>
                ...
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    ...
                    <li className="flex items-center">
                      ...
                      <span>
                        Add missing additives if needed (Alk, Calc, Mag)
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              >
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3 mb-3">
                    Inspection and Livestock Maintenance
                  </h3>
                  <p className="text-xl text-gray-400 mb-4">
                  ...
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Inspect livestock and equipment</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              >
                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  <h3 className="h3 mb-3">Special Services</h3>
                  <p className="text-xl text-gray-400 mb-4">
                    Sometimes there are services you need that fall outside the
                    normal scheduled services, but that is ok, we got you
                    covered there too!
                  </p>
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      ...
                      <span>Introduce new livestock</span>
                    </li>
                    <li className="flex items-center mb-2">
                      <svg
                        className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0"
                      ...
                      <span>Equipment setup or teardown</span>
                    </li>
                  </ul>
                </div>
              </div>
